...
<section class="comments-container">
   ...
   <p class="comment-title">gönderilere yorumların</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments">
         ...
         ?>
         <div class="post-title"> kullanıcı : <span><?= $fetch_posts['title']; ?></span> <a href="view_post.php?post_id=<?= $fetch_posts['id']; ?>" >Gönderiyi gör</a></div>
         <?php
            }
         ?>
      ...
      <?php
            ...
            echo '<p class="empty">yorum yapmadınız!</p>';
         }
      ?>
   </div>
