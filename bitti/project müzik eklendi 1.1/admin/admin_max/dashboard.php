...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <p>gönderiler </p>
      <a href="add_posts.php" class="btn">gönderi ekle</a>
   </div>
   ...
   <div class="box">
      ...
      <a href="view_posts.php" class="btn">gönderileri gör</a>
   </div>
   ...
   <div class="box">
      ...
      <p>gönderileri devre dışı bırak</p>
      <a href="view_posts.php" class="btn">gönderileri gör </a>
   </div> 
   ...
   <div class="box">
      ...
      <a href="giris.php" class="btn">kullanıcı girişlerini gör</a>
   </div>
  ...
  <!-- <div class="box">
      ...
      <p>yorumları gör</p>
      <a href="comments.php" class="btn">yorumlar</a>
   </div>
