...
include 'components/config.php';
   ...
   <section class="home-grid">
      ...
      <div class="box-container">
         ...
         <div class="box">
            ...
            <p>toplam yorum : <span><?= $total_user_comments; ?></span></p>
            <p>begenilenler: <span><?= $total_user_likes; ?></span></p>
            ...
            ?>
               <p class="name">giriş yap veya üye ol!</p>
               <div class="flex-btn">
         ...
         <div class="box">
            <p>categories</p>
            <div class="flex-box">
               <a href="category.php?category=nature" class="links">doga</a>
               <a href="category.php?category=education" class="links">egitim</a>
               <a href="category.php?category=business" class="links">işletme</a>
               <a href="category.php?category=travel" class="links">seyehat</a>
               <a href="category.php?category=news" class="links">yeni</a>
         
               <a href="all_category.php" class="btn">HEPSİ</a>
            </div>
         </div>
         <div class="box">
            <p>YAZARLAR</p>
            ...
            ?>  
            <a href="authors.php" class="btn">HEPSİ</a>
            </div>
         </div>
   ...
   <section class="posts-container">
      ...
      <h1 class="heading">SON GÖNDERİLER</h1>
      ...
      <div class="box-container">
         ...
         <form class="box" method="post">
            ...
            <a href="view_post.php?post_id=<?= $post_id; ?>" class="inline-btn">ŞİMDİ OKU</a>
