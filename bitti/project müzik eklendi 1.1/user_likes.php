...
<head>
   ...
   <title>begenilen gönderiler</title>
...
<section class="posts-container">
   ...
   <h1 class="heading"> Begenilen Gönderiler</h1>
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <a href="view_post.php?post_id=<?= $post_id; ?>" class="inline-btn">şimdi oku</a>
         <div class="icons">
      ...
      <?php
            ...
            echo '<p class="empty">yazı yok!</p>';
         }
         }
      }else{
         echo '<p class="empty">henüz begenilen gönderi yok!</p>';
      }
      ?>
   </div>
